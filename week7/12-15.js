...
function getGBP(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if(item.currency_code === "GBP") {
      ...
      outputOfGBP.push(labels);
    }
  }
  return outputOfGBP;
}
var result = getGBP(items);
...
function thingsMadeOfWood(data) {
  var output = [];
  ...
  var result = thingsMadeOfWood(items);

  // console.log(result);

// Find which items are made of eight or more materials.

function OverEight(data) {
  var output = [];
